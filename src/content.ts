...
export const prizeVisuals: Record<PrizeId, {
  ...
  'discount-3':   { color: '#4FC3F7', accent: '#002E4C', image: '/images/3-percent.png',     label: '3% OFF' },
  'discount-2':   { color: '#81C784', accent: '#0E3613', image: '/images/2-percent.png',     label: '2% OFF' },
  ...
  'discount-30k': { color: '#FFB74D', accent: '#4E2C00', image: '/images/voucher.png',   label: '-30K' },
  'discount-40k': { color: '#FFB74D', accent: '#4E2C00', image: '/images/voucher.png',   label: '-40K' },
  'discount-60k': { color: '#E57373', accent: '#3E1010', image: '/images/voucher.png',   label: '-60K' },
  'discount-70k': { color: '#E57373', accent: '#3E1010', image: '/images/voucher.png',   label: '-70K' },
  'discount-90k': { color: '#F16B4E', accent: '#FFF8EC', image: '/images/voucher.png',   label: '-90K' },
  'discount-100k': { color: '#F16B4E', accent: '#FFF8EC', image: '/images/voucher.png',  label: '-100K' },
...
export const prizeNames: Record<PrizeId, string> = {
  ...
  'discount-30k': 'Giảm 30.000vnđ',
  'discount-40k': 'Giảm 40.000vnđ',
  'discount-60k': 'Giảm 60.000vnđ',
  'discount-70k': 'Giảm 70.000vnđ',
  'discount-90k': 'Giảm 90.000vnđ',
  'discount-100k': 'Giảm 100.000vnđ',
...
export const translations = {
  ...
  countdownKicker: 'Grand opening',
  countdownDate: '28 Sep 2026 · 8 AM · Da Nang',
  days: 'Days', hours: 'Hours', minutes: 'Mins', seconds: 'Secs',
  
  aboutTitle: 'About Inside Out',
  aboutBody: 'We’re Phu, Tai, and Luc, three friends who started Innoir at D13 An Thuong 34. That little corner of Da Nang means a lot to us. It’s where we learned how much we enjoy building something together, and where the idea for Inside Out began.',
  aboutClosing: 'With Inside Out, we’re making the kind of streetwear we want in our own wardrobes. We care about how the fabric feels, how a piece fits, and whether you’ll reach for it again tomorrow. We wear what we sell, so those details matter to us. Come by, try something on, and say hello. We’d love to meet you.',
